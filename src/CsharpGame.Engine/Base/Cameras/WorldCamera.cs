...
{
    /// <summary>
    /// Camera that move's with the charachter
    /// </summary>
    public class WorldCamera : Camera
    {
        public PointF Location { get; set; }
        public WorldCamera(int screenWidth, int screenHeight, int levelWidth, int levelHeight, float speed = 10) : base(screenWidth, screenHeight, levelWidth, levelHeight, speed)
        {
